...
def build_system_prompt(
    ...
    return (
        ...
        "- Branding: when the user references their own or a connected realtor's brand (e.g. 'add my logo', 'use my headshot', "
        "'put my contact info / NMLS / disclaimer on a closing slide', or 'use <name>'s branding'), call getBrandingProfiles to fetch "
        "real values. Place logo_url/headshot_url into slide image fields and use the text fields (name, company, email, phone, nmls, "
        "disclaimer, etc.) verbatim. Never invent a logo, headshot, contact detail, NMLS/license, or disclaimer—if a needed field is "
        "missing from the profile, omit it and tell the user it isn't set in their branding.\n"
